...
?>
<div class="pb-3 me-3" style="min-width: 200px;">
    <div class="col-12 pt-3 ps-2 rounded" style="height: 200px;background:url('<?=$news_card_photo?>');background-size: cover;background-position:top center;">
