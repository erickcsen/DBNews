<?php $title_page = ucwords($category_selected)." - All Article" ?>
                ...
                <div class="col-12">
                    <div class="row">
                        <div class="col-12 p-0 text-capitalize">
                            <b class="color4a25a9" style="font-size: 18pt">{{$category_selected}}</b>
                        ...
                        <div class="col-12 py-1 pb-4">
                            <div class="row">
                                ...
                                @foreach ($article as $item)
                                    <?php $tipe = ($item->subcategory)?$item->subcategory->name : $item->category->name ?>
                                    <?php $category = $tipe ?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 mb-2 text-capitalize">
                    <b class="color4a25a9">{{$category_selected}}</b>
                ...
                <div class="col-12">
                    @foreach ($article as $item)
                        <?php 
                            ...
                            $tipe = ($item->subcategory)?$item->subcategory->name: $item->category->name ;
                            $title = $item->title;
