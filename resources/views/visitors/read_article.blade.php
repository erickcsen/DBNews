    ...
    <div id="content" class="col-12 d-none">
        <div class="container">
            <?php
                ...
                $article_content = str_replace('"></oembed></figure>','" class="col-12" frameborder="0" allowfullscreen></iframe>',$article_content);
                ...
                $article_content_mobile = str_replace('"></oembed></figure>','" class="col-12" frameborder="0" allowfullscreen></iframe>',$article_content_mobile);
            ?>
        </div>
    </div>
    {{-- Untuk Mengatur Content Yang ditampilkan --}}
